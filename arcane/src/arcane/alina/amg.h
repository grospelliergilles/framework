...
class amg
{
 public:
   ...
   *
   * This struct includes parameters for each
  ...
  /*!
   * \brief Performs single V-cycle for the given right-hand side and solution.
   *
  ...
  /*!
   * \brief Performs single V-cycle after clearing x.
   *
